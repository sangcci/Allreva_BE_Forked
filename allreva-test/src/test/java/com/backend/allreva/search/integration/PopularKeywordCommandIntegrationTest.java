package com.backend.allreva.search.integration;
...
class PopularKeywordCommandIntegrationTest extends IntegrationTestSupport {
    ...
    class Describe_키워드_카운트_업데이트 {
        ...
        class Context_새로운_키워드_검색 {
            ...
            void 키워드_카운트가_1로_증가한다() {
                ...
                // when
                keywordService.recordSearch(keyword);
    ...
    class Describe_인기_검색어_랭킹_업데이트 {
        ...
        class Context_검색_횟수_변경 {
            ...
            void 랭킹이_업데이트되고_변동_상태가_반영된다() {
                // given - 기존 랭킹 설정
                List<PopularKeywordRankItem> keywordRankList = List.of(
                        ...
                        PopularKeywordRankItem.builder()
                                ...
                                .build());
                valueOperations.set(POPULAR_KEYWORD_KEY, new PopularKeywordRanks(keywordRankList));
                ...
                // when
                keywordService.updateRank();

                // then
                List<PopularKeywordResult> updatedRank = searchFinder.getPopularKeywordRank();
                assertSoftly(softly -> {
    ...
    class Describe_인기_검색어_조회 {
        ...
        class Context_랭킹_데이터_존재 {
            ...
            void Top_10_랭킹이_반환된다() {
                ...
                // when
                List<PopularKeywordResult> topRank = searchFinder.getPopularKeywordRank();
