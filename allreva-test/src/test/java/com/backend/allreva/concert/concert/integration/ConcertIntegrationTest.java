package com.backend.allreva.concert.concert.integration;
...
class ConcertIntegrationTest extends IntegrationTestSupport {
    ...
    @Autowired
    private ConcertFinder concertService;
    ...
    class Describe_관련_공연_조회 {
        ...
        class Context_같은_공연장_공연이_여러_개 {
            ...
            void hallCode에_해당하는_공연만_반환된다() {
                ...
                // when
                List<RelatedConcertResult> result = concertService.getRelatedConcerts("HALL-A", null, 10);

                // then
                assertThat(result).hasSize(2);
                assertThat(result)
                        .extracting(RelatedConcertResult::concertCode)
            ...
            void pageSize만큼만_반환된다() {
                ...
                // when
                List<RelatedConcertResult> result = concertService.getRelatedConcerts("HALL-C", null, 2);
            ...
            void concertCode_내림차순으로_반환된다() {
                ...
                // when
                List<RelatedConcertResult> result = concertService.getRelatedConcerts("HALL-D", null, 10);
        ...
        class Context_커서_페이징 {
            ...
            void lastConcertCode_이전_공연만_반환된다() {
                ...
                // when
                List<RelatedConcertResult> result = concertService.getRelatedConcerts("HALL-E", "PF0003", 10);

                // then
                assertThat(result).extracting(RelatedConcertResult::concertCode).containsExactly("PF0002", "PF0001");
            }
        }
        ...
        class Context_poster가_없는_공연 {
            ...
            void posterUrl이_null로_매핑된다() {
                ...
                // when
                List<RelatedConcertResult> result = concertService.getRelatedConcerts("HALL-F", null, 10);
        ...
        class Context_공연이_없을_때 {
            ...
            void 빈_리스트가_반환된다() {
                // when
                List<RelatedConcertResult> result = concertService.getRelatedConcerts("HALL-EMPTY", null, 10);
    ...
    class Describe_공연_상세_조회 {
        ...
        class Context_공연_ID로_조회 {
            ...
            void 공연_상세_정보와_공연장_정보가_반환된다() {
                ...
                // when
                ConcertDetailResult result = concertService.getConcertDetail(concert.getConcertCode());
