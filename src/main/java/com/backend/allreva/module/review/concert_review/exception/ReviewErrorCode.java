...
public enum ReviewErrorCode implements ErrorCode {
    ...
    REVIEW_IMAGE_SAVE_FAILED(HttpStatus.INTERNAL_SERVER_ERROR.value(), "REVIEW_IMAGE_SAVE_FAILED", "리뷰 이미지 저장 실패"),
    ...
    REVIEW_IMAGE_DELETE_FAILED(HttpStatus.INTERNAL_SERVER_ERROR.value(), "REVIEW_IMAGE_DELETE_FAILED", "리뷰 이미지 삭제 실패");
