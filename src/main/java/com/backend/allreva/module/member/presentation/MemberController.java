...
public class MemberController implements MemberControllerSwagger {
    ...
    @GetMapping
    public Response<MemberDetailResponse> getMemberDetail(@AuthMember final Member member) {
        return Response.onSuccess(memberService.getById(member.getId()));
    }

    @GetMapping("/check-nickname")
    public Response<Boolean> isDuplicatedNickname(@RequestParam final String nickname) {
        return Response.onSuccess(memberService.isDuplicatedNickname(nickname).isDuplicated());
    }

    @PostMapping("/register")
    public Response<Void> registerMember(@RequestBody final MemberRegisterRequest memberRegisterRequest) {
    ...
    public Response<Void> updateMemberInfo(
            @AuthMember final Member member, @RequestBody final MemberRegisterRequest memberRegisterRequest) {
    ...
    public Response<Void> registerRefundAccount(
            @AuthMember final Member member, @RequestBody final RefundAccountRequest refundAccountRequest) {
        memberService.registerRefundAccount(refundAccountRequest, member);
        return Response.onSuccess();
    }

    @DeleteMapping("/refund-account")
    public Response<Void> deleteRefundAccount(@AuthMember final Member member) {
