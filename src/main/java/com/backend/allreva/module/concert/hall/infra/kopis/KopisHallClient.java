package com.backend.allreva.module.concert.hall.infra.kopis;
 ...
 */
@FeignClient(name = "kopisHallClient", url = "https://www.kopis.or.kr/openApi/restful", configuration = OpenFeignConfig.ClientXmlDecoder.class)
